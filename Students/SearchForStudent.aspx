...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="form-horizontal">
        ...
        <hr />
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="txtStartYear" CssClass="col-md-3 control-label">Enter a start year and end year:</asp:Label>
            <div class="col-md-2">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-2">
                ...
                birthdate: <asp:TextBox ID="txtCreateUserBirth" runat="server" CssClass="form-control input-sm"></asp:TextBox>
